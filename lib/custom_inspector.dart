...
var backendURL = "https://budgettra7327back.builtwithrocket.new/log-inspected-widget";
  ...
  void _handleTap() {
    if (_selectedElement != null && isInspectorEnabled) {
      try {
        ...
        // print("Error sending widget info: $err");
      }
    }
  }
...
void _sendWidgetInformation(Map<String, dynamic> widgetInfo) async {
  try {
    ...
    if (response.ok) {
      ...
      // print('Error reporting widget information: ${response.statusText}');
    }
  } catch (e) {
