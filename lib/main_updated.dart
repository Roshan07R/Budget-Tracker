...
var backendURL = "https://budgettra7327back.builtwithrocket.new/log-error";
...
class MyRouteObserver extends RouteObserver<PageRoute<dynamic>> {
    ...
    void _sendOverflowError(FlutterErrorDetails details) async {
      try {
        ...
        if (response.ok) {
          ...
          // print('Error reporting overflow: ${response.statusText}');
        }
      } catch (e) {
